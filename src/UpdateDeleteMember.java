...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setLocation(new java.awt.Point(176, 100));
        setUndecorated(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String age = jTextField10.getText();
         ...
         {
             Connection Con=ConnectionProvider.getCon();
             PreparedStatement ps=Con.prepareStatement("Update member set name=?,mobilenumber=?,email=?,fathername=?,mothername=?,uniqueid=?,age=?,amount=? where id=?");
             ps.setString(1, name);
