...
public class NewMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(0, 118, 225));
        jButton1.setForeground(new java.awt.Color(0, 118, 225));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "5:00AM-8:00AM", "7:00PM-11:00PM" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String fathername=jTextField4.getSelectedText();
        String mothername=jTextField5.getSelectedText();
        String gymtime=(String)jComboBox2.getSelectedItem();
        String uniqueid=jTextField6.getSelectedText();
        String age=jTextField7.getSelectedText();
        String amount=jTextField8.getSelectedText();
        try{
            Connection Con= ConnectionProvider.getCon();
